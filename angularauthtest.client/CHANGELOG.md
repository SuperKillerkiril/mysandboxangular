...
- Create Angular project with ng: `ng new angularauthtest.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularauthtest.client.esproj`).
